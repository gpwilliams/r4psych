...
1. Let's assume we want to know if the density of the mean reaction times differs across word class within our items.
...
4. Now we want to check the distribution of the reaction times depending on word class and the language spoken by our participants.
...
5. Now we want to explore if there's any relationship between the mean reaction time to our items and the frequency of the item.
...
6. Now we want to know how many males and females took part in our experiment.
...
7. What if we want to know the mean age and distribution of ages split by language spoken and gender?
...
8. Next, we want to see the mean (and standard error) of reaction times to words with different word frequencies.
...
9. Finally, we want to show a few of our graphs in one display.
