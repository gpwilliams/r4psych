...
url: 'http\://glennwilliams.me/r4psych/'
...
To download the course content, get the lesson materials from my [GitHub repo](https://github.com/gpwilliams/r4psych/tree/master/lesson_materials). You can follow along with the slides using the R notebooks.
