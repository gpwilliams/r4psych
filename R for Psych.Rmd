...
<!--chapter:end:02-Data_Visualisation_One.Rmd-->
...
<!--chapter:end:03-Data_Visualisation_Two.Rmd-->
...
<!--chapter:end:04-Data_Manipulation_One.Rmd-->
...
<!--chapter:end:05-Data_Manipulation_Two.Rmd-->
...
<!--chapter:end:06-Simple_Statistical_Tests.Rmd-->
...
<!--chapter:end:07-Advanced_Statistical_Tests_and_Evaluating_Null.Rmd-->
...
<!--chapter:end:08-Simulation_and_Calculating_Power.Rmd-->
...
<!--chapter:end:09-Mixed_Effects_Models.Rmd-->
...
For this exercise, we'll look at doing a full analysis using a data set and report from the excellent [Open Stats Lab](https://sites.trinity.edu/osl). For simplicity, we’ll load this data directly from a csv file stored on GitHub. (To get a link for this, you must view the raw file on GitHub online.)
...
# read in the data
raw_data <- read_csv(
  "https://raw.githubusercontent.com/gpwilliams/r4psych/master/lesson_materials/10_reporting_reproducible_research/inputs/schroeder_epley_2015.csv"
  )
```
...
<!--chapter:end:10-Reporting_Reproducible_Research.Rmd-->
