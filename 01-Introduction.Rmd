...
11. Access all rows and columns where the test score is greater than 12.

*Hint*: use quotations to define the column name, and perform a logical operation on this.

12. Access all rows from the participant_number and IQ columns where the test score is greater than 13.
