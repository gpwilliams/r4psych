...
# specify design
wsubj_design <- list(ivs = c(A = 2),
                  n_item = 40
                  )

# specify parameters
beta <- list("(Intercept)" = c(300, 350), 
             "AA2" = c(100, 120)
             )
theta <- c(25, 50)
sigma <- c(25, 30)
...
corr_data <- tibble(
  ...
  weight = c(rnorm(n = 30, mean = 84, sd = 7.5), rnorm(n = 30, mean = 69, sd = 7.5)),
