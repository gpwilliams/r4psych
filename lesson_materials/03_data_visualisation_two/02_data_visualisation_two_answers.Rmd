...
Next, we'll create our own data for use in other plots.
...
# reaction time mean and sd aggregated by items
...
```
These plots won't look perfect, and you may need to change the font and element sizes, but this can be done relatively easily. We won't cover this in class.
