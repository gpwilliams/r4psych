...
Access all rows and columns where the test score is greater than 12.
...
Access all rows from the participant_number and scores columns where the test score is greater than 13.

*Hint*: use the `c()` function to select multiple columns.
```{r answer_12}
data["scores" > 13, c("participants", "scores")]
```
